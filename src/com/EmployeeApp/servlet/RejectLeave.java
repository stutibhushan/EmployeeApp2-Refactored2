...
/**
 * Servlet implementation class RejectLeave
 */
	...
	private static final long serialVersionUID = 1L;
	   ...
	   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   try
		   {
			...
			status=dao.rejectLeave(employeeId, leaveType, date);
			 ...
			 if(status!=0)
		      {
		        ...
		        out.println("\"message\": \"Leave Rejected\"");
		        out.println("}");
		      }
		      else
		      {
		    	  out.println("{");
			        ...
			        out.println("\"message\": \"Unable to reject\"");
			        out.println("}");
