...
public class EmployeeLoginModule implements LoginModule {
	...
	static Logger log = Logger.getLogger(EmployeeLoginModule.class.getName());
	...
	public void initialize(Subject subject, CallbackHandler callbackHandler,
		...
		log.info(new Date() +"login module intialize method "+EmployeeLoginModule.class);
	...
	public boolean abort() throws LoginException {
		// TODO Auto-generated method stub
		log.info("Login Module - abort called");
		return false;
	}
